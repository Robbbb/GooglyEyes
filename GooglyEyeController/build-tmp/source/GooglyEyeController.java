...
public class GooglyEyeController extends PApplet {
...
public void sinuasoidalBounce() {
  ...
  int pupilR= PApplet.parseInt(map(sinuasoid, -1, 1, -255, 255));
   int pupilThetaDegrees = PApplet.parseInt(map(sinuasoid, -1, 1, 0, 360));
...
public void findGazeDrawEye(PVector origin, PVector target) {
  ...
  //  int discreteRotaryGoal  = int(map(sinuasoid, -1, 1, 0, 16));
  // constrain(sinuasoid,-1,1);
    thetaGoal = PApplet.parseInt(map(sinuasoid, -1, 1, 0, 360));
...
//}
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "GooglyEyeController" };
    if (passedArgs != null) {
