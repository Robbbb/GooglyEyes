...
// #include <Firmata.h>  // Easiest most reilable way to move values from computer to Arduino //Not used at the moment
...
void setup() {
  ...
  Serial.begin(9600);
  // Serial.println("instructable at instructables.com/id/E6APAUWI5GN9L8M");//");//
